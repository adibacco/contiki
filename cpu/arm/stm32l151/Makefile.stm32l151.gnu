PROP_SYS_ARCH_S = startup_stm32l151xb.s
...
ifndef LDSCRIPT
LDSCRIPT = $(CONTIKI)/platform/$(TARGET)/stm32cube-lib/stm32cube-prj/linker/gcc/STM32L151RBHx_FLASH.ld
endif

#ASFLAGS += -mcpu=cortex-m3 -mthumb

# this platform wields a STM32L151VB medium-density device
